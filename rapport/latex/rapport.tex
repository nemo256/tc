    ...
    \begin{center}
        ...
        \begin{mdframed}[style=MyFrame]
            ...
            \color{Black}
              ...
              \LARGE{\textbf{en utilisant NextJS}}
            \end{center}
        \end{mdframed}
    \end{center}
...
\vspace{0.25in}
 {\centering\fontsize{30}{40}{\bfseries{\color{Black}{\scshape{Chapitre I : Étude Général}}}}}
\vspace{0.35in}\\
    {\color{Black} \rule{\linewidth}{1.2mm} }
\end{center}
\vspace*{\fill}
\addcontentsline{toc}{chapter}{\color{Black}{Chapitre I : Étude Général}}
...
\begin{tabular}{|l|l|c|}
\hline
\textbf{Diagramme}                                                       & \textbf{Objectifs}                                                                                                                                                                                                                                                                                                                                                                                                                    & \multicolumn{1}{l|}{\textbf{Type}} \\ \hline
...
\end{tabular}
\caption{Les diagrammes utilisés}
\end{table}
...
\centering
  \vspace{-0.1in}
    \centerline{\fbox{\includegraphics[width = 6.6in, height = 4in]{../images/usecase.png}}}
...
\begin{figure}[h]
\centering
    \centerline{\fbox{\includegraphics[width = 6.6in, height = 3.8in]{../images/deployment.png}}}
    \caption{Diagramme des composants général}
\end{figure}
...
\begin{tabular}{|c|l|}
\hline
\textbf{Le matériel} & \multicolumn{1}{c|}{\textbf{Caractéristiques}}                                                                                                                                                                        \\ \hline
\textbf{PC 1}        & \begin{tabular}[c]{@{}l@{}}Marque : Apple\\ Modèle : Macbook Air (13-inch, Mid 2013)\\ RAM : 4GB 1600MHz LPDDR3\\ CPU : Intel Core i5 1.3GHz dual-core (2.6GHz TB)\\ Système d'exploitation : Arch Linux\end{tabular} \\ \hline
\textbf{PC 2}        & \begin{tabular}[c]{@{}l@{}}Marque : HP\\ Modèle : Pavilion 5\\ RAM : 4GB 1600MHz LPDDR3\\ CPU : Intel Core i5-8250u 1.6GHz quad-core (3.4GHz TB)\\ Système d'exploitation : Windows 10\end{tabular}                   \\ \hline
\textbf{PC 3}        & \begin{tabular}[c]{@{}l@{}}Marque : HP\\ Modèle : Notebook 255 G3\\ RAM : 4GB 1600MHz LPDDR3\\ CPU : AMD E1-6010 1.35GHz APU\\ Système d'exploitation : Windows 10\end{tabular}                                       \\ \hline
\end{tabular}
\caption{L’environnement matériel}
\end{table}
...
\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.2in]{../images/accueil.png}}
...
\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.2in]{../images/services.png}}
...
\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.2in]{../images/stats.png}}
\caption{Les statistiques}
\end{figure}
...
\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.2in]{../images/testimonials.png}}
\caption{Les témoignages}
\end{figure}

\newpage

\subsection{Page chambres}

\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.2in]{../images/chambres.png}}
\caption{Page chambres}
\end{figure}
...
\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.2in]{../images/chambres2.png}}
\caption{Choix des chambres}
\end{figure}

\newpage

\subsection{Page contacter-nous}

\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.2in]{../images/contacterNous.png}}
\caption{Page contacter-nous}
\end{figure}
...
\begin{figure}[H]
\centering
    \fbox{\includegraphics[width = 6.6in, height = 4.2in]{../images/contacterNousCard.png}}
\caption{Formulaire contacter-nous}
\end{figure}
...
\begin{minipage}{.34\textwidth}
  \fbox{\includegraphics[width = 2.1in, height = 4.7in]{../images/testimonialsMobile.png}}
\end{minipage}%
\begin{minipage}{.33\textwidth}
  \fbox{\includegraphics[width = 2.1in, height = 4.7in]{../images/chambre2Mobile.png}}
\end{minipage}
\begin{minipage}{.32\textwidth}
  \fbox{\includegraphics[width = 2.1in, height = 4.7in]{../images/contacterNousCardMobile.png}}
\end{minipage}
